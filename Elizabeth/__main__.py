...
PM_START_TEXT = f"""
`Hi..Welcome` 👀
`I'm Group Manager Bot Developed by "Request Movies" Family.` 
...
buttons += [[InlineKeyboardButton(text="💾SOURCE CODE",
                                  url="https://github.com/REQUESTMOVIES-FAMILY/ELIZABETH"),
             InlineKeyboardButton(text="🌳SUPPORT",
                                  url="https://t.me/RM_MAINTENANCE"),
]]
...
HELP_STRINGS = f"""
`Hi.. I'm Group Manager Bot Developed by "Request Movies" Family.`
